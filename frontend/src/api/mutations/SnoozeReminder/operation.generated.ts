...
export type SnoozeReminderMutationVariables = Exact<{
  id: string | number;
  option: Types.SnoozeChoice;
}>;


export type SnoozeReminderMutation = { snoozeReminder:
...
export const SnoozeReminderDocument = gql`
    mutation SnoozeReminder($id: ID!, $option: SnoozeChoice!) {
  snoozeReminder(id: $id, option: $option) {
    __typename
    ... on Reminder {
      ...ReminderFields
    }
