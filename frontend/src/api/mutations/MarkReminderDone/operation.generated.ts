...
export type MarkReminderDoneMutationVariables = Exact<{
  id: string | number;
}>;


export type MarkReminderDoneMutation = { markReminderDone:
...
export const MarkReminderDoneDocument = gql`
    mutation MarkReminderDone($id: ID!) {
  markReminderDone(id: $id) {
    __typename
    ... on Reminder {
      ...ReminderFields
    }
