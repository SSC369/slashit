...
| 004 | [Persistent Memory](./004-persistent-memory/) | P0 | 1 PRD | draft | Epic approved 2026-09-25. PRD drafted; waiting on user approval, with Q5 (NFR numbers) and Q6 (backup window) open for the build plan | 2026-09-25 |
