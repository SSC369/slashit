...
| 003 | [Reminders and Notifications](./003-reminders-and-notifications/) | P0 | 3 Build plan | in-review | Epic, PRD and design approved 2026-09-23. User approval of the build plan; Q1 to Q11 all answered. Still owed by the user before the first real email: the sending domain's name, verified in Resend | 2026-09-23 |
