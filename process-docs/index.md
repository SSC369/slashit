...
| 003 | [Reminders and Notifications](./003-reminders-and-notifications/) | P0 | 4 Implementation plan | in-review | Epic, PRD, design and build plan approved 2026-09-23. User approval of the implementation plan index and sub-plan 4.1 (Set and manage); sub-plans 4.2 to 4.4 drafted as earlier slices land. Still owed before the first real email: the sending domain, verified in Resend | 2026-09-23 |
