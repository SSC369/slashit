...
| 003 | [Reminders and Notifications](./003-reminders-and-notifications/) | P0 | 5 Dev | in progress | Implementation plan index and sub-plan 4.1 approved 2026-09-23. Slice 1 (Set and manage) built and tested 2026-09-23; its live browser pass (T-1.14) is owed, blocked here by no Supabase project or model key. Sub-plan 4.2 (Fire in the app) approved and built 2026-09-23; its live browser pass (T-2.15) is owed for the same reason. Sub-plan 4.3 (Email and settings) approved and built 2026-09-23; email ships switched off, and its first real send (T-3.10) waits on a verified sending domain. Sub-plan 4.4 (Timezone and hardening) approved and built 2026-09-23. All four slices built; not yet shipped: live browser passes (T-1.14, T-2.15) and the first real email (T-3.10) are owed. Still owed before the first real email: the sending domain, verified in Resend | 2026-09-23 |
| 004 | [Persistent Memory](./004-persistent-memory/) | P0 | 5 Dev | in progress | Slice 1 (Save and browse) built 2026-09-25 on 003's merged base: 336 backend and 176 frontend tests pass against local PostgreSQL with pgvector. Owed: the embedding model name check (T-1.1), the category set's correction and live score (T-1.11), a live browser pass (T-1.14). Slices reordered: 4.2 is Forget, approved and built 2026-09-25 (358 backend and 192 frontend tests pass; live browser pass T-2.11 owed), 4.3 Conflicts (not drafted); all three ship together. Backup window deferred to launch | 2026-09-25 |
