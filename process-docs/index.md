...
| 003 | [Reminders and Notifications](./003-reminders-and-notifications/) | P0 | 5 Dev | in progress | Implementation plan index and sub-plan 4.1 approved 2026-09-23. Slice 1 (Set and manage) built and tested 2026-09-23; its live browser pass (T-1.14) is owed, blocked here by no Supabase project or model key. Sub-plans 4.2 to 4.4 drafted as earlier slices land. Still owed before the first real email: the sending domain, verified in Resend | 2026-09-23 |
