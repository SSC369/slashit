...
| 004 | [Persistent Memory](./004-persistent-memory/) | P0 | 4 Implementation plan | draft | Build plan approved 2026-09-25. Index and sub-plan 4.1 (Save and browse) drafted; waiting on user approval. Sub-plans 4.2 (Conflicts) and 4.3 (Forget) drafted after. No code until 003 merges to `main` (AD-10). Backup window deferred to launch | 2026-09-25 |
